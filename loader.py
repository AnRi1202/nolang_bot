...
def load_faq_data():
    ...
    try:
        ...
        for item in faq_items:
            question_elem = item.find(['h2', 'h3', 'h4', 'dt'], class_=re.compile(r'question|title'))
    ...
    try:
        ...
        for row in data_rows:
            ...
            if question:
                ...
                mapping = INQUIRY_TYPE_MAPPING.get(inquiry_type, INQUIRY_TYPE_MAPPING["その他のお問い合わせ"])
